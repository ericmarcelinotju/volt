<template>
  <main
    class="absolute h-full w-full bg-cover bg-top sm:bg-top"
    style="
  ...
  >
    ...
    >
      <p
        ...
        "
      >
        {{ $t("app.components.forbidden.headline") }}
      </p>
      <h1
        class="
          mt-2
        ...
        "
      >
        {{ $t("app.components.forbidden.title") }}
      </h1>
      <p class="mt-2 text-lg font-medium text-black text-opacity-50">
        {{ $t("app.components.forbidden.description") }}
      </p>
      <div class="mt-6">
        <a
          class="
          ...
          href="/"
        >
          {{ $t("app.components.forbidden.goBack") }}
        </a>
      </div>
    </div>
  </main>
